...
class AcademiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create academy" do
    assert_difference("Academy.count") do
      post academies_url, params: { academy: { email: @academy.email, name: @academy.name, phone: @academy.phone } }
    end
  ...
  test "should update academy" do
    patch academy_url(@academy), params: { academy: { email: @academy.email, name: @academy.name, phone: @academy.phone } }
