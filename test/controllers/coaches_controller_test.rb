...
class CoachesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coach" do
    assert_difference("Coach.count") do
      post coaches_url, params: { coach: { email: @coach.email, name: @coach.name, phone: @coach.phone, sobrenome: @coach.sobrenome, username: @coach.username } }
    end
  ...
  test "should update coach" do
    patch coach_url(@coach), params: { coach: { email: @coach.email, name: @coach.name, phone: @coach.phone, sobrenome: @coach.sobrenome, username: @coach.username } }
